...
public class LoggerAdvice {
    ...
    // any parameter
    @Pointcut("execution (* cat.tecnocampus.tinder.application.TinderController.*Profile*(..))")
    ...
    @Pointcut("within(cat.tecnocampus.tinder.api..*) && args(java.security.Principal)")
    ...
    @Pointcut("execution(java.util.List<cat.tecnocampus.tinder.domain.Like> * (..))")
    ...
    @Pointcut("execution(* cat.tecnocampus.tinder.application.TinderController.getCandidates*(..)) && args(user)")
